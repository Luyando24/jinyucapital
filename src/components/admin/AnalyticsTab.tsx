    ...
    sorted.forEach((o) => {
      ...
      const dateKey =
        timeFrame === "7d" || timeFrame === "30d"
          ? d.toLocaleDateString(language === "zh" ? "zh-CN" : language === "ru" ? "ru-RU" : language === "fr" ? "fr-FR" : "en-US", { month: "short", day: "numeric" })
          : d.toLocaleDateString(language === "zh" ? "zh-CN" : language === "ru" ? "ru-RU" : language === "fr" ? "fr-FR" : "en-US", { month: "short", year: "2-digit" });
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="bg-card border p-5 rounded-2xl shadow-sm">
          ...
          <div className="text-2xl font-black tracking-tight">
            ${totalRevenue.toLocaleString(language === "zh" ? "zh-CN" : language === "ru" ? "ru-RU" : language === "fr" ? "fr-FR" : "en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
          </div>
        ...
        <div className="bg-card border p-5 rounded-2xl shadow-sm">
          ...
          <div className="text-2xl font-black tracking-tight">
            ${avgOrderValue.toLocaleString(language === "zh" ? "zh-CN" : language === "ru" ? "ru-RU" : language === "fr" ? "fr-FR" : "en-US", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
          </div>
          <p className="text-xs text-muted-foreground mt-2">
        ...
        <div className="bg-card border p-5 rounded-2xl shadow-sm">
          ...
          <p className="text-xs text-muted-foreground mt-2">
            {t("Catalog Value: {value}", { value: `$${totalCatalogValue.toLocaleString(language === "zh" ? "zh-CN" : language === "ru" ? "ru-RU" : language === "fr" ? "fr-FR" : "en-US", { maximumFractionDigits: 0 })}` })}
          </p>
        </div>
      </div>
                ...
                filteredProductsList.slice(0, 10).map((prod) => {
                  ...
                  return (
                    <tr key={prod.id} className="hover:bg-muted/30 transition-colors">
                      ...
                      <td className="p-4 font-bold text-foreground">${val.toLocaleString(language === "zh" ? "zh-CN" : language === "ru" ? "ru-RU" : language === "fr" ? "fr-FR" : "en-US", { minimumFractionDigits: 2 })}</td>
