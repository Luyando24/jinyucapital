...
import { ArrowLeft, Upload, Plus, Trash2, Loader2, Lock } from "lucide-react";
...
export default function AdminNewProductPage() {
  ...
  // Force pure light cream/white styling
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const newProductPayload = {
        ...
        description: description.trim() || "Experience premium gym gear with Jinyu Capital.",
        rating: 5.0,
        reviews_count: 0,
      ...
      <div className="bg-gray-50 min-h-screen py-24 flex items-center justify-center px-4">
        <div className="max-w-md w-full bg-white border border-primary/20 rounded-lg shadow-xl overflow-hidden text-center relative">
          ...
          <div className="p-8 space-y-6">
            ...
            <Link 
              href="/login?redirect=/admin/products/new"
        ...
        <div className="max-w-4xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <h1 className="text-xl font-serif font-bold text-gray-955">Publish Premium Fitness Gear</h1>
            </div>
          </div>
      ...
      <main className="max-w-4xl mx-auto px-6 mt-8">
        <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <h3 className="font-serif text-base font-bold text-gray-950 border-b border-gray-100 pb-3 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="e.g. Jinyu Pro Cast Iron Kettlebell"
                ...
                <div>
                  <label className="block text-[10px] font-bold text-gray-700 uppercase tracking-wider mb-1.5">
                    External Image URL (Optional Fallback)
                  </label>
                  <input
                    type="text"
                    value={imageUrl}
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    placeholder="Provide details about weight, resistance levels, material construction, dimensions, grip style, etc..."
                    rows={4}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-gray-50/50 p-6 border border-gray-200 rounded-xl flex flex-col justify-between">
                  <div>
                    ...
                    <span className="block text-[10px] text-gray-400 mb-4">
                      This will be the main image shown in shop lists, catalogs, and checkout.
                    </span>
                  </div>
                  ...
                  {mainImagePreview ? (
                    <div className="relative aspect-[4/5] rounded-lg overflow-hidden bg-gray-100 border border-gray-200 group">
                      ...
                      <button 
                        ...
                        className="absolute top-3 right-3 bg-black/60 hover:bg-red-655 text-white rounded-full p-2 transition-colors text-xs font-bold shadow-md"
                      >
                        ✕ Remove
                      </button>
                    </div>
                ...
                <div className="bg-gray-50/50 p-6 border border-gray-200 rounded-xl flex flex-col">
                  <div>
                    ...
                    <span className="block text-[10px] text-gray-400 mb-4">
                      Add different lighting angles, styled mockups, or textures to populate the shop carousel.
                    </span>
                  </div>

                  <div className="grid grid-cols-3 gap-3 flex-1">
                    {secondaryPreviews.map((url, idx) => (
                      <div key={idx} className="aspect-square relative rounded-lg overflow-hidden bg-gray-100 border border-primary/20 group">
